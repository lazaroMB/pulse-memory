...
func (c *GeminiClient) GenerateAnswer(ctx context.Context, message string, history []entity.ChatMessage, facts []entity.Fact) (string, error) {
...
func (c *GeminiClient) ExtractFacts(ctx context.Context, message string) ([]entity.ExtractedFact, error) {
...
func (c *GeminiClient) ExtractRelations(ctx context.Context, message string) ([]entity.ExtractedRelation, error) {
