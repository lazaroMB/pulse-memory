...
// OpenAIClient implements the LLMService interface using OpenAI's public REST APIs.
...
func (c *OpenAIClient) GenerateAnswer(ctx context.Context, message string, history []entity.ChatMessage, facts []entity.Fact) (string, error) {
...
func (c *OpenAIClient) ExtractFacts(ctx context.Context, message string) ([]entity.ExtractedFact, error) {
...
%s`, message)
	...
	var extracted []entity.ExtractedFact
...
func (c *OpenAIClient) ExtractRelations(ctx context.Context, message string) ([]entity.ExtractedRelation, error) {
...
%s`, message)
	...
	var extracted []entity.ExtractedRelation
	if err := json.Unmarshal([]byte(cleanedJSON), &extracted); err != nil {
